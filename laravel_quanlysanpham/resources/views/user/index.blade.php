                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ ($key + 1) }}</td>
                                    <td class="py-1">
                                        <img src="{{ $item->avatar }}" class="img img-fluid img" style="object-fit: cover;"
                                    ...
                                    <td>
                                        <a href="{{ route('user.delete', $item->id) }}" class="btn-text text-danger"><i class="btn-icon-prepend" data-feather="trash"></i> </a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
